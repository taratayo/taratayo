                                            ...
                                            <div className="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                                                <form action="#" className="search-property-1">
                                                    <div className="row no-gutters">
                                                        ...
                                                        <div className="col-lg col-md-4 col-12 d-flex">
                                                            <div className="form-group p-4">
                                                                ...
                                                                <div className="form-field">
                                                                    ...
                                                                    <input onClick={() => setOpenDate(!openDate)} type="text" className="form-control checkin_date" placeholder="Check In Date" value={`${format(date[0].startDate, "MM/dd/yyyy")}`} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg col-md-4 col-12 d-flex">
                                                            <div className="form-group p-4">
                                                                ...
                                                                <div className="form-field">
                                                                    ...
                                                                    <input onClick={() => setOpenDate(!openDate)} type="text" className="form-control checkout_date" placeholder="Check Out Date" value={`${format(date[0].endDate, "MM/dd/yyyy")}`} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg col-md-4 col-4 d-flex">
                                                            <div className="form-group p-4">
                                                                <label htmlFor="#">Adult</label>
                                                                <input type="text" className="form-control" value="1" />
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-2 col-md-4 col-4 d-flex">
                                                            <div className="form-group p-4">
                                                        ...
                                                        <div className="col-lg col-md-12 d-flex">
                                                            <div className="form-group d-flex w-100 border-0">
                                                                <div className="form-field w-100 align-items-center d-flex">
                                                                    <input type="submit" value="Search" className="align-self-stretch form-control btn btn-primary p-4 rounded-r-lg" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
