                        ...
                        <div className="col-md pt-5 border-left">
                            <div className="ftco-footer-widget pt-md-5 mb-4">
                                ...
                                <div className="block-23 mb-3">
                                    <ul>
                                        <li><span className="icon fa fa-map-marker"></span><span className="text">203 Fake St. Mountain View, San Francisco, California, USA</span>
                                        </li>
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center">
                            ...
                            <p>
                                ...
                                2022 All rights reserved | This template is made with <i className="fa fa-heart"
